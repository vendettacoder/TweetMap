...
io.sockets.on('connection', function(socket) {
    socket.on("start tweets", function(filter) {
        ...
        r.connect({
            ...
            if (filter == "all") {
                r.db('tweetDB').table('tweetStreamNew').run(live_connection).then(function(res_data) {
                ...
                r.db('tweetDB').table('tweetStreamNew').changes().run(live_connection).then(function(cursor) {
